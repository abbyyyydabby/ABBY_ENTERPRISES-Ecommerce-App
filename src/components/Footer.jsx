      ...
      <Container maxWidth="lg">
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Typography variant="body2">
              Project Maintainer:{' '}
              <Link href="https://github.com/abbyyyydabby" color="inherit" sx={{ textDecoration: 'underline', '&:hover': { color: '#f50057' } }}>
                Abhinav Sagar
              </Link>
            </Typography>
            <Typography variant="body2">
              Email:{' '}
              <Link href="mailto:www.alphastriker123@gmail.com" color="inherit" sx={{ textDecoration: 'underline', '&:hover': { color: '#f50057' } }}>
                wwww.alphastriker123@gmail.com
              </Link>
            </Typography>
            <Typography variant="body2">Phone: +91 7599194701</Typography>
        ...
        >
          <Typography variant="body2">© {new Date().getFullYear()} ABBY ENTERPRISES . All rights reserved.</Typography>
        </Box>
      </Container>
    </Box>
  );
